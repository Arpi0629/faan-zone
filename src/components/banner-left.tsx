...
export const BannerLeft: React.FC<Props> = ({ className }) => {
        ...
        {isLoading ? (
          ...
          <>
            ...
            {[...Array(1)].map((_, i) => (
              <li
                key={`plus-${i}`}
                className="bg-gray-100 cursor-pointer shadow-lg rounded-lg flex flex-col items-center justify-center w-[300px] h-[300px] transition-transform hover:scale-105 hover:translate-x-[8px]"
              >
                <Plus
                  size={35}
                  strokeWidth={3}
